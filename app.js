...
const KKS_MAPPINGS = {
  "System classification code": "System Description",
  "EAC": "Transport system of refuse",
  "EAE": "Refuse bunker system",
  "EAT": "Weighbridge system",
  "EGA": "Receiving equipment incl. Pipeline",
  "EGB": "Tank farm",
  "EGC": "Pump system",
  "EGH": "Piping system",
  "EKG": "Piping system",
  "EKJ": "Natural gas system",
  "EKS": "Biogas system",
  "EKZ": "Pressure regulating station",
  "ETA": "Conveying system for wet ash",
  "ETB": "Storage system for wet ash",
  "ETD": "Conveying system for slag",
  "ETE": "Slag pit",
  "ETF": "Slag pit demisting system",
  "ETG": "Conveying system for dry ash",
  "ETH": "Storage system for dry ash",
  "ETJ": "Fly ash stability workshop ammonia removal system",
  "ETN": "Reclaimed water system for slag pit",
  "EUM": "Fly ash stabilization system",
  "GAA": "Extraction, mechanical cleaning",
  "GAC": "Piping and channel system",
  "GAG": "Chemicals supply system",
  "GAH": "Storage system",
  ...
  "GCA": "Boiler makeup water treatment system",
  "GCB": "Filtering, mechanical cleaning system",
  "GCC": "Aeration, gas injection system",
  "GCD": "Precipitation system",
  "GCE": "Acid proportioning system",
  "GCF": "Ion exchange, reverse osmosis system",
  "GCH": "Deaeration",
  ...
  "GHC": "Demineralized water distribution system (demineralization)",
  "GHD": "Distribution system after treatment (integrated water purifier)",
  "GHE": "Clean water pump system (not drinking water)",
  "GKC": "Drinking water treatment system",
  "GKD": "Drinking water supply",
  "GKE": "Drinking water supply pipeline network",
  "GKF": "Main workshop drinking water supply",
  "GKG": "Water supply and treatment system building drinking water supply",
  "GKP": "Water pump house drinking water supply",
  "GKQ": "Auxiliary system building drinking water supply",
  "GKR": "Chimney drinking water supply",
  "GMA": "Waste water collection system",
  "GMB": "Chemical waste water collection system",
  "GMC": "Oily waste water collection system",
  "GMD": "Process drainage pipeline network",
  "GME": "Main workshop process drainage",
  "GMF": "Step-up substation process drainage",
  "GMP": "Water pump house process drainage",
  "GMR": "Chimney process drainage",
  "GMS": "Ramp process drainage",
  ...
  "GQA": "Domestic waste water pipeline network",
  "GQB": "Main workshop domestic waste water drainage",
  "GQC": "Step-up substation domestic waste water drainage",
  "GQG": "Water supply and treatment system building domestic waste water drainage",
  "GQP": "Water pump house domestic waste water drainage",
  "GQQ": "Auxiliary system building domestic waste water drainage",
  "GQR": "Chimney domestic waste water drainage",
  "GRC": "Aeration, gas injection system",
  "GRK": "Temporary storage system",
  "GRM": "Biochemical treatment system",
  "GRN": "Chemicals supply system",
  "GRP": "Regeneration, flushing equipment",
  "GRS": "Sludge thickening system",
  "GTA": "Collection system",
  "GTB": "Pretreatment system",
  "GTC": "Biochemical treatment system",
  "GTD": "Biochemical treatment system",
  "GTE": "Biochemical treatment system",
  "GTF": "Biochemical treatment system",
  "GTH": "Aeration system",
  "GTJ": "Membrane treatment system",
  "GTK": "Membrane treatment system",
  "GTL": "Membrane treatment system",
  "GTM": "Membrane treatment system",
  "GTN": "Leachate recirculation spraying system",
  "GTP": "Sludge thickening system",
  "GTQ": "Deodorization system",
  "GTR": "Product water distribution system",
  "GTS": "Concentrated water treatment system",
  "GUA": "Rainwater pipeline network",
  "GUB": "Main workshop rainwater waste drainage",
  "GUC": "Step-up substation rainwater waste drainage",
  "GUG": "Water supply and treatment system building rainwater waste drainage",
  "GUP": "Water pump house rainwater waste drainage",
  "GUR": "Chimney rainwater waste drainage",
  "GUV": "Rainwater treatment system",
  "GUW": "Rainwater reuse system",
  "HAC": "Economizer system",
  "HAD": "Evaporator system",
  "HAH": "Hp superheater system",
  "HAJ": "Reheat system",
  "HAN": "Pressure system drainage and venting system",
  "HAP": "Boiler blowdown system",
  "HBA": "Frame incl. Foundation",
  "HBB": "Enclosure",
  "HBC": "Brick lining incl. Insulating brickwork",
  "HBD": "Platform, stairway",
  ...
  "HHA": "Auxiliary burner",
  "HHC": "Incinerator/grate combustion system",
  "HHD": "Biogas furnace feeding system",
  ...
  "HLA": "Ducting system",
  "HLB": "Forced draught fan system (primary air, secondary air)",
  "HLC": "Air preheating (not flue gas heated)",
  "HLD": "Air preheating flue gas heated",
  "HLJ": "Furnace cooling air system",
  "HLQ": "Other air systems",
  "HNA": "Ducting system",
  "HNC": "Induced-draught fan system",
  "HNE": "Smoke stack system (chimney)",
  "HNF": "Flue gas recirculation system",
  "HNG": "Flue gas heating utilization system",
  "HRA": "Activated carbon injection system",
  "HSB": "Steam gas heater system",
  "HSD": "SCR reactor system",
  ...
  "HSL": "Water supply system",
  "HSP": "Fly ash collecting system (incl. Filtering) and removal system",
  "HSU": "Heating fluid system",
  "HSV": "PNCR system",
  "HTB": "GGH system",
  "HTD": "Wet method of desulfurization system",
  "HTE": "Bag filter system",
  "HTF": "Wet method cycle system",
  "HTH": "Spray reactor/flue gas cooling reactor",
  "HTJ": "Absorbent supply system incl. Storage system (semi-dry desulfurization+dry desulfurization)",
  "HTK": "Absorbent preparation and distribution system (semi-dry desulfurization+dry desulfurization)",
  "HTQ": "Water supply system",
  "HTT": "Drainage system",
  ...
  "LBD": "Extraction piping system (excluding high-pressure heater and low-pressure heater)",
  "LBE": "Back-pressure piping system",
  "LBF": "Overpressure suppression and safety device incl. Injection and hydraulic station for safety function",
  "LBG": "Auxiliary steam piping system",
  "LBH": "Start-up steam system, shutdown steam system",
  "LBJ": "Moisture separator/reheater (MSR)",
  "LBL": "Heating steam for Steam Gas Heater",
  "LBQ": "Extraction steam piping system for HP feed-water heating",
  "LBR": "Piping system for branch or auxiliary turbine",
  "LBS": "Extraction steam piping system for LP feed-water heating (main condensate)",
  "LBT": "Emergency condensing system",
  "LBU": "Common dump line",
  "LBV": "Lubrication System",
  "LBW": "Sealing steam system",
  "LBX": "Fluid supply system for control and protection equipment",
  "LBY": "Control and protection equipment",
  "LCA": "Main condensate piping system (excl. main condensate pump system, feedwater heating system, condensate polishing plant)",
  ...
  "LCK": "Steam Gas Heater drains system",
  "LCL": "Turbine drains system",
  "LCM": "Clean drains system (drain flash tank and drain tank system)",
  "LCN": "Auxiliary steam condensate system (collecting and return system)",
  "LCP": "Bypass condensate system, incl. storage and pump system",
  "LCQ": "Steam generator blowdown system",
  "LCR": "Condensate distribution system",
  "LCS": "Reheater drains system (moisture separator/reheater)",
  "LCT": "Moisture separator drains system (moisture separator/reheater)",
  "LCV": "Lubrication System (condensate pump)",
  ...
  "MAH": "Motive water system (include ejector pump and tank)",
  "MAJ": "Condenser vacuum system (include liquid ring vacuum pump or water jet air ejector)",
  ...
  "MAQ": "Vent system",
  "MAU": "Control oil system",
  "MAV": "Lubricating oil system",
  ...
  "MKA": "Generator",
  "MKC": "Generator excitation system",
  "MKD": "Generator bearing system",
  "MKI": "Stator/rotor liquid cooling system, incl. coolant supply system",
  "NDA": "Hot water supply system for heating",
  "NDB": "Hot water return system for heating",
  "NDC": "Heating circulating pump system",
  "NDD": "Heating heat exchanger unit system",
  "NDF": "Heating manifold and collector system",
  "NDK": "Secondary pressure boosting pump system for heating",
  "NEA": "Chilled water supply system",
  "NEB": "Chilled water return system",
  "NEC": "Chilled water circulating pump system",
  "NED": "Chiller system",
  "NEE": "Thermal storage system",
  "NEF": "Refrigeration manifold and collector system",
  "PAA": "Circulating water system 1",
  "PAB": "Circulating water piping and culvert system",
  "PAC": "Circulating water pump system",
  "PAE": "Cooling tower pump system",
  "PAG": "Cooling tower fan system",
  "PAH": "Condenser cleaning system",
  "PAR": "Make-up water piping system",
  "PAT": "Cooling tower blowdown system",
  "PAU": "Circulating water side filtration treatment system",
  "PCC": "Pump system",
  "PCD": "Auxiliary system building service water system",
  "PGA": "Pump system",
  "PGB": "Closed cooling water piping system",
  "PGC": "Closed cooling water piping system for air compressor",
  "PUE": "Scale and corrosion inhibitors dosing device",
  "PUL": "Sodium hypochlorite dosing device",
  "PUM": "Sulfuric acid dosing device",
  "QCA": "Hydrazine dosing system",
  "QCB": "Ammonia dosing system",
  "QCC": "Phosphate dosing system",
  "QCH": "Sodium hydroxide dosing system",
  "QEA": "Plant compressed air system within compressor room (plant air receiver)",
  "QEB": "Plant compressed air system outside compressor room (distribution)",
  "QEC": "Compressed air generation system by air compressors",
  "QED": "Air dryer processing system",
  "QEE": "Intermediate buffer tank system",
  "QFA": "Adsorption dryer processing system",
  "QFB": "Instrument compressed air system (instrument air receiver)",
  "QUA": "Sampling system for feedwater system",
  "QUB": "Sampling system for steam system",
  "QUC": "Sampling system for condensate system",
  "QUG": "Sampling system for demineralized water system",
  "QUP": "Sampling system for cooling water system",
  "QUW": "Sampling system for liquid waste/ waste water",
  "SAA": "Main workshop ventilation and air conditioning system",
  "SAB": "Step-up substation/main transformer room ventilation and air conditioning system",
  "SAD": "Mechanical smoke exhaust system",
  "SAE": "Refuse bunker emergency deodorization system",
  "SAK": "Mechanical pressurization system",
  "SAP": "Water pump house, circulating pump house ventilation and air conditioning system",
  "SAR": "Chimney ventilation and air conditioning system",
  "SAS": "Ramp ventilation and air conditioning system",
  "SBA": "Internal main workshop heating system",
  "SBB": "Step-up substation/main transformer room heating system",
  "SBE": "Refuse bunker heating system",
  "SBP": "Water pump house, circulating pump house heating system",
  "SBR": "Chimney heating system",
  "SBS": "Ramp heating system",
  "SGA": "Fire water supply equipment",
  "SGB": "Firefighting piping network",
  "SGC": "Indoor fire hydrant system",
  "SGD": "Fire monitor system",
  "SGE": "Sprinkler system",
  ...
  "SMG": "Water treatment system lifting equipment",
  "XKA": "Emergency diesel generator"
};

function getSystemFromKks(kksNo) {
  if (!kksNo) return 'Main System';
  kksNo = kksNo.trim().toUpperCase();
  
  // Extract first 3 letters after any leading digits (e.g. "80EAC31" -> "EAC")
  const match = kksNo.match(/^\d*([A-Z]{3})/);
  if (match && match[1]) {
    const code = match[1];
    return KKS_MAPPINGS[code] || 'Main System';
  }
  
  // Fallback to first 3 characters directly
  const first3 = kksNo.substring(0, 3);
  return KKS_MAPPINGS[first3] || 'Main System';
}
...
async function saveInstrumentForm(e) {
  ...
  let area = document.getElementById('instArea').value.trim();
    if (!area || area === 'Main System') {
      const computedArea = getSystemFromKks(tag);
      if (computedArea) area = computedArea;
    }
...
function processRawImportData(matrix) {
  ...
  for (let r = 1; r < matrix.length; r++) {
    ...
    let area = getSystemFromKks(tag);
      if (area === "Main System" && colIndices.area !== -1) {
        const sheetArea = String(row[colIndices.area] || "").trim();
        if (sheetArea) area = sheetArea;
      }
...
function setupEventListeners() {
  // Auto-fill System based on KKS No. in form modal
  const instTagInput = document.getElementById('instTag');
  const instAreaInput = document.getElementById('instArea');
  if (instTagInput && instAreaInput) {
    instTagInput.addEventListener('input', (e) => {
      const tagVal = e.target.value;
      const computedSystem = getSystemFromKks(tagVal);
      if (computedSystem && computedSystem !== 'Main System') {
        instAreaInput.value = computedSystem;
      }
    });
  }
